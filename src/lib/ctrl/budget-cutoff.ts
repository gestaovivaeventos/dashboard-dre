...
// planilha-base cobre o realizado até 06/07/2026; ocorrências com vencimento a
// partir de 07/07/2026 — inclusive parcelas e recorrências já lançadas —
// continuam descontando do orçamento. Sem due_date, cai pra data de criação.
const BUDGET_IMPORT_BASELINE_YEAR = 2026;
const BUDGET_IMPORT_BASELINE_DUE_START = "2026-07-07";
