...
export async function POST(request: Request) {
  ...
  // Regra do editor: no plano GLOBAL novas contas sao sempre folhas e precisam
  // se anexar a uma conta pai existente — criar contas de nivel 1 no plano
  // global mudaria a estrutura validada compartilhada por todas as empresas
  // sem plano customizado. Ja num plano CUSTOMIZADO por empresa (companyId !=
  // null) permitimos contas de nivel 1 (top-level), pois cada plano e isolado
  // e nao afeta outras empresas (ex.: linhas extras da Viva Juiz de Fora).
