...
- Fases seguintes previstas no modelo, não construídas: juros automáticos com CDI do Banco Central (`rate_basis='cdi'`) e edição de lançamentos aprovados (hoje a única exclusão de aprovado é o Desvincular da triagem da Omie).
