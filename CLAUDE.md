...
- **Caixa** (prefixed `caixa_*`): `caixa_accounts` (espelho do cadastro Omie + saldo corrente), `caixa_balance_snapshots` (cada captura), `caixa_sync_runs` (execuções). Predicado de policy: `caixa_has_access()`.
